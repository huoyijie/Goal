...
func (*OperationLog) TranslateActionStrings() map[string]map[string]string {
    return map[string]map[string]string{ "en": {"post": "Add", "put": "Change", "delete": "Delete"}, "zh_CN": {"post": "新增", "put": "修改", "delete": "删除"}}
} 
